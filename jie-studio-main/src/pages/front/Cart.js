...
function Cart(){
    ...
    <div className="container">
      ...
      {cartData?.carts?.length === 0 ?(
        <>
          <div className="text-center py-7 mt-7">
              <div style={{ fontSize: '5rem', color: 'var(--jie-rose)', opacity: 0.4 }}>
                <i className="bi bi-cart-x" />
              </div>
              <h4 className="fw-bold mt-3 mb-2">購物車是空的</h4>
              <p className="text-muted mb-4">快去探索我們的美甲商品吧！</p>
              <Link to="/products" className="btn btn-dark px-5 py-2 fw-semibold">
                  前往購物
              </Link>
          </div>
      </>
